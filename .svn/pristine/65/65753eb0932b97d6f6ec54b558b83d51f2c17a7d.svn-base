...
ES.MapView.BaseTabPanel.SiteVehLst = ES.MapView.BaseTabPanel.BaseLst.extend({
    ...
    initData: function (nPage, fnCall) {
        ...
        if (this.anDeptId && this.anDeptId.length > 0) {
            ...
            ES.extend(oTemp, {WorkSiteIds: _anDeptId,WorkSiteType:1});
...
ES.MapView.BaseTabPanel.SiteVehLst.include({
    ...
    '       <div class="clearfix"></div>' +
    '   </div>' +
    '   <div class="carlist-bottom" style="display:none">' +
