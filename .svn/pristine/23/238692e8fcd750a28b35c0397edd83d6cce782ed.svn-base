...
ES.CloudMap.TypeExample.include({
    ...
    '   <li class="ec-form-group show" data-type="site"><label class="ec-checkbox-inline ec-success" data-type="no-report"><em class="ex-maptool-icon site now"></em>  正常工地</label></li>'+
    ...
    '   <li class="ec-form-group show" data-type="site"><label class="ec-checkbox-inline ec-success" data-type="no-report"><em class="ex-maptool-icon site no-report"></em>   未上报未出土工地</label></li>'+
    '   <li class="ec-form-group show" data-type="site"><label class="ec-checkbox-inline ec-success" data-type="no-report"><em class="ex-maptool-icon site environ excellent1"></em>   上报未出土工地</label></li>'+
