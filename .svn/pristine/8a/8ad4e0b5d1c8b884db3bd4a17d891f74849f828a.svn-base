...
'   <div id="TrackMapView" class="ex-layout-map-content"></div>' +
...
'       <ul class="ex-layout-track-chart">' +
...
'                                   <td colspan="5" class="TrackPanel-emOrStrong ec-text-right" id="tdBeginDate"></td>' +
'                                   <td></td>' +
'                               </tr>' +
'                               <tr>' +
'                                       <td><strong>结束时间</strong></td>' +
'                                   <td colspan="5" class="TrackPanel-emOrStrong ec-text-right" id="tdEndDate"></td>' +
'                                   <td></td>' +
'                               </tr>' +
'                           </tbody>' +
'                       </table>' +
...
'               <dl class="ex-layout-track-chart-box" style="max-height:340px">' +
'                   <a href="javascript:void(0);" class="ec-close">&times;</a>' +
'                   <dt><i class="ec-icon-line-chart"></i>&nbsp;&nbsp;速度、顶棚、载重</dt>' +
'                   <dd  style="max-height:340px">' +
'                       <div id="speedWeightDoorChartView">' +
'                           <div id="divSpeedWeightChart" style="width:280px;height:150px"> </div>' +
'                           <div id="divDoorChart" style="width:280px;height:150px" > </div>' +
'                       </div>' +
'                   </dd>' +
'               </dl>' +
'           </li>' +
...
'               </dl>' +
'           </li>' +
'           <li class="track-chart-box" style="height:260px;">' +
'               <dl class="ex-layout-track-chart-box">' +
...
'                   <label><input type="checkbox" checked  class="ckbPopup"/>气泡</label>' +
'               </li>' +
'               <li class="ec-form-group ec-form-select ec-form-icon">' +
'                   <label><input type="checkbox" checked class="ckbTrackLine" />轨迹线</label>' +
'               </li>' +
'               <li class="ec-form-group ec-form-select ec-form-icon">' +
'                   <label><input type="checkbox" class="ckbTrackPos"/>轨迹点</label>' +
'               </li>' +
