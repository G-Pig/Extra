...
ES.MapView.Menu.include({
    ...
    '           list-show = "close"' +
    '            list-url="QueryNormalVeh" ><i class="ec-icon-building"></i> <span>工地列表</span>' +
    '       </li>' +
    ...
    '           list-show = "close"' +
    '            list-url="QueryNormalVeh" ><i class="ec-icon-download"></i> <span>消纳点列表</span>' +
    '       </li>' +
    //
    // '       <li class="ec-active flip in level" ' +
    ...
    // '           list-show = "close"' +
    // '            list-url="QuerySuspicVeh" ><i class="ec-icon-upload"></i> <span>可疑工地</span>' +
    // '       </li>' +
    //
    // '       <li class="ec-active flip in level" ' +
    ...
    // '           list-show = "close"' +
    // '            list-url="QuerySuspicVeh" ><i class="ec-icon-download"></i> <span>可疑消纳点</span>' +
    // '       </li>' +
    ...
    '           view-title="车辆告警类型" '+
    '             ><i class="ec-icon-warning"></i> <span>告警分类</span>' +
    '       </li>' +
    '</ul>',
});