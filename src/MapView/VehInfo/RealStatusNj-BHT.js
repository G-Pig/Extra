...
ES.VehInfo.RealStatusNj = ES.VehInfo.extend({
    ...
    loadDetailView: function (oData) {
        ...
        this.$_oContent.load("/MapView/DetailView",
            ...
            function () {
                ...
                $('.truck_box').addClass('BHT').find('#echartsWeight').remove();

                self.oMapMonitor = new ES.VehInfo.MapMonitor(self, {
                    oMapOption: {
                        zoomControl: false,
                        layers: [],
    ...
    setGpsInfo: function (oGpsInfo) {
        ...
        var startL = cMsg.indexOf('+');
        cMsg.substr(0,startL)
    ...
    setVehStatusInfo: function (oGpsInfo) {
        ...
        $.inArray(15, oStatus)<0 ? $('.car-cover').animate({"left": "-360px"}, 500) : $('.car-cover').animate({"left": "0px"}, 500);
    ...
    setVehLight: function (oGpsInfo) {
        ...
        var cClass = "";
        if ((oGpsInfo.attach.ZtLeightGreenOn  + oGpsInfo.attach.ZtLeightRedOn  + oGpsInfo.attach.ZtLeightYelloOn ) != 1) {
            cClass = "l-gray";

        }
        else if (oGpsInfo.attach.ZtLeightGreenOn  == 1) {
            cClass = "l-green";
            $('a[cId="cz"]').addClass('green');
        }
        else if (oGpsInfo.attach.ZtLeightRedOn == 1) {
            cClass = "l-red";
    ...
    setBtnTrackEven: function (oData) {
        ...
        $(".ex-btn-track").bind("click", function () {
            window.open("/MapView/TrackViewV2?PhoneNum=" + oData.oGpsInfo.devNo + "&VehicleNo=" + oData.oGpsInfo.vehNo);
        })
    },
