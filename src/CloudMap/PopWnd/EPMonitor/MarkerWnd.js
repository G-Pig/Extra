...
ES.CloudMap.MarkerWnd = ES.CloudMap.PopWnd.extend({
    ...
    save: function () {
        ...
        var oParam = {
            ...
            DeptId: this.cParentId.replace('d_',''),//this.cParentId,
            CloudType: 2,
...
ES.CloudMap.MarkerWnd.include({
    ...
    '       <div class="ec-u-sm-8"><input type="text" id="MarkerName" name="form-sitename" placeholder="请输入国控点名称" class="ec-form-field ec-radius ec-input-sm"></div>'+
    '    </li>'+

    '    <li class="ec-form-group">'+
    '    <label for="form-selectDate" class="ec-u-sm-4 ec-form-label"> 区域：</label>'+
    '       <div class="ec-u-sm-8"><input type="text" id="MarkerDeptName" name="form-sitename"  placeholder="请输入区域" class="ec-form-field ec-radius ec-input-sm">'+
    '    </div>'+
    '    </li>'+
