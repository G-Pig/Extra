 ...
 * 扬尘噪音操作
 */
ES.MapView.DustVoiceLayer = L.MapLib.MapMaster.MapOpr.extend({

    //执行画点，画线操作
    oOption: {
        onEvenSetData: 'MV:DustVoice.setDustData',
        onEvenSetStatusData: 'MV:DustVoice.setStatusData',
        onEvenClearSites: 'MV:DustVoice.clearSites',
