...
ES.Muck.Search = ES.Muck.BaseSearch.extend({
    initUI: function () {
        ...
        this.oVehicleMatch =$('#VehicleMatch');//同步
    ...
    initEvent:function() {
        ...
        //同步
        this.oVehicleMatch.bind('click',function(){
            self._oParent.oDelD = new ES.Common.MatchDialog(self._oParent,{bRemove:true,cUrl:'/Vehicle/VehicleMatch'},{
                title: '同步车辆数据',
                content: '是否同步车辆数据？'});
            self._oParent.oDelD.del();
            // self._oParent.oEditD = new ES.Common.MatchDialog(self._oParent,{bRemove:true,cUrl:'/Vehicle/VehicleMatch'});
