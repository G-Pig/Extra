 ...
 */
ES.Muck.VehicleInfoMgr=ES.Page.extend({
    ...
    initEvent: function () {
        // $('#form-dateStart,#form-dateEnd').parents("li").hide();
        // $('#form-selectDate').bind('change', function () {
        //     if ($(this).val() == 2) {
        //         $('#form-dateStart,#form-dateEnd').parents("li").show();
        //     } else {
        //         $('#form-dateStart,#form-dateEnd').parents("li").hide();
        //     }
        // });
