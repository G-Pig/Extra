    ...
    initClick: function (e, oModel) {
        ...
        if ($(e.target).hasClass('Edit')) {
            if(oModel.Type == 1){
                ...
                window.top.oWebFrame.oMenuFrame.oFooter._oParent.fire('TabPanel.addPage', { cId: "+" + oModel.CompanyId, cUrl: url, cName: '正式处置证编辑' });
                window.top.oWebFrame.oTabPanel._oParent.fire('TabPanel.addPage', { cId: "+" + oModel.CompanyId, cUrl: url, cName: '正式处置证编辑' });
                ...
                window.top.oWebFrame.oMenuFrame.oFooter._oParent.fire('TabPanel.addPage', { cId: "+" + oModel.CompanyId, cUrl: url, cName: '临时处置证编辑' });
                window.top.oWebFrame.oTabPanel._oParent.fire('TabPanel.addPage', { cId: "+" + oModel.CompanyId, cUrl: url, cName: '临时处置证编辑' });
            }
        }
