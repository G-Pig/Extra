            ...
            },
            {
                ...
                formatter: function (val, opt, item) {
                    ...
                    if(item.StatusStr == "区城管审核"){
                        content += '<button class="ec-btn ec-btn-xs ec-btn-success examine"' + btnAuth.check + '><i class="ec-icon-eye examine"></i>  审核</button>';
                        content += '  ';
                    }
