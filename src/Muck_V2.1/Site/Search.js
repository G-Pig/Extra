...
ES.Muck.Search = ES.Muck.BaseSearch.extend({
    ...
    initEvent:function() {
        ...
        this.oSearchBtn.bind('click', function () {
            ...
            var approval = $("input[name='s_approval']:checked").val() || "";
            var startState = $("#ddl_StartState").val();
            var oParam ={ Name: name, WorkTimeStart: workstart, WorkTimeEnd: workend, ApprovalStatus: approval, StartState: startState };
            // 触发查询
        ...
        this.oAddBtn.bind('click', function () {
            self._oParent.oEditD = new ES.Common.Dialog(self._oParent,{bRemove:true,cUrl:'/Site/Edit'});
