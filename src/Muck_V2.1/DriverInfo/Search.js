...
ES.Muck.DriverSearch = ES.Muck.BaseSearch.extend({

    initUI: function () {
        this.oSearchInput =$('#driverName');
    ...
    initEvent:function() {
        ...
        this.oAddBtn.bind('click',function(){
            oParent.oAddD = new ES.Common.Dialog(oParent,{bRemove:true,cUrl:'/DriverInfo/Edit'});
