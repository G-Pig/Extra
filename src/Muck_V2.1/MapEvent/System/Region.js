/**
 * Created by YangHang on 2017/12/13.
 */
...
ES.MapBase.Region = ES.MapBase.extend({
    ...
    drawRegion: function (oText) {
        ...
        var cSubText = oText.cText.substring(0, nIndex).trim();
    ...
    drawRegionHandler: function (oData) {
        ...
        //var aoAllTemp = [];
        if(!oData.districts[nIndex]) return ;
    ...
    getRegionByGaodeApi: function (cName, fnCallBack, oContext) {
        var url = "http://restapi.amap.com/v3/config/district?subdistrict=1&extensions=all&level=district&key=9acbfbce340109d41e0a9d5260aef056&s=rsv3&output=json&keywords="+cName;
        $.ajax({
            type: "GET",
            url: url,
            dataType: "json",
