...
function getFiles(compsBase32) {
	...
	//var depdds = require('./deps.js').deps;
...
exports.build = function (callback, compsBase32, buildName, vertion, path) {
	...
	var copy = fs.readFileSync('src/copyright.js', 'utf8').replace('{VERSION}', vertion).replace('{NAME}',buildName),
		...
		outro = '}(window, document,  jQuery));',
		newSrc = copy + intro + combineFiles(files,vertion) + outro,


		pathPart = (path || 'C:\\ATaoCodeMHIS\\MHIS2017\\MHIS.Web\\Asset\\scripts\\site\\MapView\\') + buildName + '-' + vertion,
